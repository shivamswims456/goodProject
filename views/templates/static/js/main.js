(function($) {
    ...
    $('.customer-feedback-active').owlCarousel({
        ...
        autoplaySpeed: 1000,
        navText: ['<i class="fa fa-angle-left" style="color:white;"></i>', '<i class="fa fa-angle-right" style="color:white;"></i>'],
        nav: true,
        dots: false,
        responsive: {
            0: {
    ...
    $('.vision-mission').owlCarousel({
        ...
        autoplayTimeout: 5000,
        autoplaySpeed: 1000,
        navText: ['<span class="mv">MISSION<span/>', '<span class="mv">VISION<span/>'],
        nav: true,
        dots: false,
        responsive: {
            0: {
    ...
    $('.category-active').slick({
        ...
        slidesToShow: 8,
        slidesToScroll: 1,
        prevArrow: "<div class='d-flex align-items-center justify-content-center slick-prev controls pull-left'><i class='fa fa-angle-left' aria-hidden='true'></i></div>",
        nextArrow: "<div class='d-flex align-items-center justify-content-center slick-next controls pull-right'><i class='fa fa-angle-right' aria-hidden='true'></i></div>",
        responsive: [{
                breakpoint: 1200,
                settings: {
                    slidesToShow: 5,
